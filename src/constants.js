...
export const PLAYER1_SPRITES = [
  ...
  [0 * CELL_SIZE, 1 * CELL_SIZE, CELL_SIZE, CELL_SIZE],
  ...
  [0 * CELL_SIZE, 2 * CELL_SIZE, CELL_SIZE, CELL_SIZE],
  ...
  [0 * CELL_SIZE, 3 * CELL_SIZE, CELL_SIZE, CELL_SIZE],
...
export const ENEMY_TANK_SPRITES = [
  ...
  [8 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus up
  [9 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus up move
  [14 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus right
  [15 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus right move
  [12 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus down
  [13 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus down move
  [10 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus left
  [11 * CELL_SIZE, (ENEMY_TANK_TYPE + 8) * CELL_SIZE, CELL_SIZE, CELL_SIZE], // bonus left move
];
